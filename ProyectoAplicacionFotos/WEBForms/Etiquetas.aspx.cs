...
namespace ProyectoAplicacionFotos.WEBForms
{
    public partial class Etiquetas : System.Web.UI.Page
    {
        ...
        {
            if (TxtId.Text.Length > 0 && TxtNombre.Text.Length > 0 && TxtTotal.Text.Length > 0 && txtUS.Text.Length > 0 && TxtCodigo.Text.Length > 0)
            {
                if (cCLS_Etiquetas.Agregar_Etiquetas(Convert.ToInt32(TxtId.Text), TxtNombre.Text, TxtTotal.Text, txtUS.Text, Convert.ToInt32(TxtCodigo.Text)))
                {
        ...
        protected void BtnActualizar_Click(object sender, EventArgs e)
        {
            if (TxtId.Text.Length > 0 && TxtNombre.Text.Length > 0 && TxtTotal.Text.Length > 0 && txtUS.Text.Length > 0 && TxtCodigo.Text.Length > 0)
            {
                if (cCLS_Etiquetas.Modificar_Etiquetas(Convert.ToInt32(TxtId.Text), TxtNombre.Text, TxtTotal.Text,txtUS.Text ,Convert.ToInt32(TxtCodigo.Text)))
                {
